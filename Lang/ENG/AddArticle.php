        ...
        <?php
            ...
            ?>
                ...
                <div class="HexagonGroupAdmin">
                    ...
                    <h2 id="hexagonProject1-title">Edition / New Brief</h2>
                </div>
                ...
                <form id="Edition" action="Files/Article/Article_Add.php" method="post" enctype="multipart/form-data">
                    ...
                    <label for="NbrParagraphe">Number of paragraphs</label>
                    <input type="number" id="NbrPara" name="NbrPara" min="1" max="5" onchange="NbrParagraphe()" value="1">
                    <textarea class="paragraphe" placeholder="Paragraph..."></textarea>
                    <select type="text" name="NumLang" placeholder="Languages" id="Here">
                    ...
                    <input type="submit" name="Envoie" value="VALID">
                </form>
               ...
               for (let index = 0; index < Nbr;  index++) {
                    ...
                    if(ActualPara == 1){
                        here.insertAdjacentHTML('beforebegin',
                                 '<textarea class="paragraphe" placeholder="Paragraph..." name="Paragraphe1"></textarea>');
                    }
                    else if(ActualPara > 1){
                        here.insertAdjacentHTML('beforebegin',
                                '<input class="paragraphe" name="Subtitle' + ActualPara + 
                                '" type="text" placeholder="Subtitle ' + ActualPara + 
                                '" required> <br class="paragraphe" /><textarea class="paragraphe" type="text" name="Paragraphe'
                                + ActualPara + '" placeholder="Paragraph ' + ActualPara + '..." required></textarea><br class="paragraphe" />');
                        }
                }
            }
